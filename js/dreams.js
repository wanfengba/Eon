  ...
  */
  ...
  jPopup.prototype = {
    ...
    _render: function _render() {
      document.body.insertAdjacentHTML('beforeend', "<div class=\"jPopup jPopup--".concat(this.options.transition, "\"><button type=\"button\" class=\"jPopup-closeBtn\">关闭</button><div class=\"jPopup-content\">").concat(this.options.content, "</div></div>"));
